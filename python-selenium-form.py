...
class TestCalculator(unittest.TestCase):
    ...
    def test_empty_input(self):
        """
        Test sprawdzający zachowanie kalkulatora przy pustych polach wejściowych
        """
        # Given
        number1 = self.driver.find_element(By.ID, "number1")
        number2 = self.driver.find_element(By.ID, "number2")
    ...
    def test_decimal(self):
        """
        Test sprawdzający działanie kalkulatora z liczbami dziesiętnymi
        """
        # Given
        number1 = self.driver.find_element(By.ID, "number1")
        number1.clear()
        number1.send_keys("1.5")
        number2 = self.driver.find_element(By.ID, "number2")
        number2.clear()
        number2.send_keys("2.5")
